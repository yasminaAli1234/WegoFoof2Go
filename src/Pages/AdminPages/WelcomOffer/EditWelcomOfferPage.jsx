...
const EditWelcomOfferPage = () => {
    ...
    return (
        <form onSubmit={(event) => handleSubmitEdit(offerContent.id, event)} className="w-full flex flex-col items-center justify-center gap-y-10">
            <div className="w-full flex flex-wrap items-center justify-start gap-10">
                ...
                <div className="lg:w-[30%] sm:w-full flex items-center gap-x-4 w-full">
                        <span className="text-2xl text-mainColor font-medium">Activition:</span>
                         <div>
