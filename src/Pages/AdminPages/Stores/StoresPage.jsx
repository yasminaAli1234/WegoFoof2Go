...
const StoresPage = () => {
    ...
    const handleCloseDialog = () => {
       ...
       const deleteStore = async (storeId, authToken) => {
              try {
                const response = await axios.delete(` https://www.wegostores.com/admin/v1/store/delete/${storeId}`, {
                        headers: {
                ...
                <table className="w-full sm:min-w-0">
                    ...
                    <tbody className="w-full">
                            {stores.map((store, index) => (
                                <tr className="w-full border-b-2" key={store.id}>
                                        <td
                                        ...
                                        <td
                                                className="min-w-[150px] sm:min-w-[100px] sm:w-2/12 lg:w-2/12 py-2 text-center text-thirdColor text-sm sm:text-base lg:text-lg xl:text-xl overflow-hidden"
                                        >
                                                {store?.link_cbanal || 'Null'}
                                        </td> 
                                        <td
                                                className="min-w-[150px] sm:min-w-[100px] sm:w-2/12 lg:w-2/12 py-2 text-center text-thirdColor text-sm sm:text-base lg:text-lg xl:text-xl overflow-hidden"
                                        >
                                                {store?.link_store || 'Null'}
                                        </td>
                                                                                        ...
                                                                                        <div className="flex items-center">
                                                                                                <div className="mt-2 text-center">
                                                                                                        <DialogTitle as="h3" className="text-xl font-semibold leading-10 text-gray-900">
                                                                                                                You will delete store {store.store_name|| "null"}
                                                                                                        </DialogTitle>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
