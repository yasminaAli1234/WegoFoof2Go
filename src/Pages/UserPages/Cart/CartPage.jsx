...
//             <p className="text-2xl font-semibold text-green-600">{calculateTotal()} EGP</p>
//           </div>
//         </div>
//       )}
...
//           Clear Cart
//         </button>
//         <Link to="../checkout" state={{cartItems:cartItems}} className="flex justify-center w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold text-lg"        >
//         <button>
//           Proceed to Checkout
//         </button>
//         </Link>
