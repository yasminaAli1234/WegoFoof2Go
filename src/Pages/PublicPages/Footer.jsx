...
const Footer = () => {
  const {t} = useTranslation()
    return (
      <footer className="bg-white text-mainColor py-12">
        {/* Footer Container */}
  ...
  <img src={payment} alt=""  />
        ...
        <div className="border-t border-gray-600 mt-8 pt-4">
          <div className="max-w-screen-xl mx-auto flex justify-between items-center">
            {/* Left: Links (Home, Plan, Contact Us) */}
            <ul className="flex space-x-6">
              <li>
                <a href="#section1" className="text-mainColor cursor-pointer hover:text-blue-800 underline">{t("Home")}</a>
              </li>
              <li>
                <a href="#plan" className="text-mainColor cursor-pointer hover:text-blue-800 underline">{t("Plan")}</a>
              </li>
              <li>
                <a href="#contactUs" className="text-mainColor cursor-pointer hover:text-blue-800 underline">{t("Contact Us")}</a>
              </li>
            </ul>

  
            {/* Right: Copyright */}
            <p className="text-mainColor">{t("©2024. All rights reserved.")}</p>
          </div>
        </div>
